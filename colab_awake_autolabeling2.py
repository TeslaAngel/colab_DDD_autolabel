...
# initiate dataset
DATASET_DIR_PATH = f"{HOME}/dataset2"
...
ANNOTATIONS_DIRECTORY_PATH = f"{HOME}/dataset2/train/labels"
IMAGES_DIRECTORY_PATH = f"{HOME}/dataset2/train/images"
DATA_YAML_PATH = f"{HOME}/dataset2/data.yaml"
...
!zip -r /content/archive.zip /content/dataset2
