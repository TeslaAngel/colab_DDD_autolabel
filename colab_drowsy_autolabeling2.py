...
IMAGE_DIR_PATH = f"{HOME}/colab_DDD_autolabel/images_drowsy_2"
#!mkdir {HOME}/images
...
# initiate dataset
DATASET_DIR_PATH = f"{HOME}/dataset2d"
...
ANNOTATIONS_DIRECTORY_PATH = f"{HOME}/dataset2d/train/labels"
IMAGES_DIRECTORY_PATH = f"{HOME}/dataset2d/train/images"
DATA_YAML_PATH = f"{HOME}/dataset2d/data.yaml"
...
!zip -r /content/archive.zip /content/dataset2d
