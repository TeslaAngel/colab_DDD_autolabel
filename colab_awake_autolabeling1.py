...
IMAGE_DIR_PATH = f"{HOME}/colab_DDD_autolabel/images_awake_1"
#!mkdir {HOME}/images
...
# initiate dataset
DATASET_DIR_PATH = f"{HOME}/dataset1"
...
ANNOTATIONS_DIRECTORY_PATH = f"{HOME}/dataset1/train/labels"
IMAGES_DIRECTORY_PATH = f"{HOME}/dataset1/train/images"
DATA_YAML_PATH = f"{HOME}/dataset1/data.yaml"
...
!zip -r /content/archive.zip /content/dataset1
